...
def get_paths(datasets, root='/ccvl/net/ccvl15/shuhao/domain_adaptation/datasets', train_list = None):
    ...
    for dataset in datasets:
        ...
        test_roots.append(test_root)
        test_lists.append(test_list)

    return root_dirs, train_lists, test_roots, test_lists

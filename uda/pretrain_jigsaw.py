...
from pretrain_functions import pretrain_jigsaw
from datasets import build_dataset

from torch.utils.data import DataLoader
from models.vnet_parallel_jigsaw import VNet
...
for epoch in range(args.start_epoch, args.epochs):
	pretrain_jigsaw(model, model_ema, train_loader, optimizer, logger, saver, args, epoch, contrast, criterion)
